...
export default async function TransactionsPage({
  ...
  const pagedTransactions = paged.transactions;
  const merchantCounts = await transactionCountsByPayeeIds(pagedTransactions.map((transaction) => transaction.payeeId ? String(transaction.payeeId) : ""));
  ...
  return (
    <AppShell sidebar={<Sidebar />} header={<Header />}>
      <div className="w-full space-y-6 px-4 py-4 md:px-0 md:py-0">
        ...
        <TransactionList transactions={pagedTransactions} wallets={formData.wallets} categories={formData.categories} subcategories={formData.subcategories} payees={formData.payees} reviewMode={reviewOnly} merchantCounts={merchantCounts} />
