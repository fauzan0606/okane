  ...
  return {
    ...
    payee: transaction.payee
      ? {
          ...
          note: transaction.payee.note,
        }
      : null,
    installmentPlan: transaction.installmentPlan
      ? {
          id: transaction.installmentPlan.id,
          transactionId: transaction.installmentPlan.transactionId,
          ...
          tenorMonths: transaction.installmentPlan.tenorMonths,
...
export async function getTransactions() {
  const transactions = await prisma.transaction.findMany({
    where: {},
    include: { wallet: { include: { currency: true } }, category: true, payee: true, installmentPlan: true },
