  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => { if (!isOpen && mode === "create") resetCreateForm(); setOpen(isOpen); }}>
      ...
      <DialogContent className="sm:max-w-xl">
        <DialogHeader><DialogTitle>{mode === "create" ? "Add Transaction" : "Edit Transaction"}</DialogTitle><DialogDescription>Record an income or expense.</DialogDescription></DialogHeader>
