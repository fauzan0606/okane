...
type TransactionListProps = { transactions: TransactionWithRelations[]; wallets: WalletOption[]; categories: Category[]; subcategories: Subcategory[]; payees: Payee[]; reviewMode?: boolean; merchantCounts?: Record<string, number> };
