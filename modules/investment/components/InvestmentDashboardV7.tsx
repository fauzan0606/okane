...
export default function InvestmentDashboardV7() {
  ...
  useEffect(() => {
    ...
    const loadRealizedAndPriceState = async () => {
      try {
        ...
        // Underlying dashboard remains usable if the supplemental realized/price state cannot load.
      }
    };
  ...
  return <div className="space-y-3">
    <div className="mx-auto flex w-full max-w-[1450px] items-center justify-between rounded-2xl border border-white/10 bg-[#0d151e] px-4 py-3 shadow-sm">
      <div>
