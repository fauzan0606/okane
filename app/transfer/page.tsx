...
export default async function TransferPage() {
  const [wallets, transfers, investmentCashAccounts] = await Promise.all([
    ...
    prisma.investmentCashAccount.findMany({
      ...
      include: { account: { select: { id: true, name: true, currency: { select: { code: true } }, provider: { select: { name: true } } } } },
